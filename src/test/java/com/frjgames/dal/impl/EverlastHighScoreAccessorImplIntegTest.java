...
import com.frjgames.dal.models.EverlastHighScore.EverlastHighScoreBuilder;
...
/**
 * Functional integ test for {@link EverlastHighScoreAccessorImpl} class.
 *
 * @author fridge
 */
@RunWith(MockitoJUnitRunner.class)
public class EverlastHighScoreAccessorImplIntegTest {
    ...
    @Before
    public void setup() {
        TestDataAccessConfig config = new TestDataAccessConfig(EverlastHighScoreDdbItem.class);

        accessor = config.everlastHighScoreAccessor();
    }
    ...
    private EverlastHighScore newData(final Consumer<EverlastHighScoreBuilder> modifier) {
        EverlastHighScoreBuilder builder = newData().toBuilder();
