...
/**
 * Tests the {@link GameTimestampConverter} class.
 *
 * @author fridge
 */
@RunWith(DataProviderRunner.class)
public class GameTimestampConverterTest {
    ...
    public void test(final long timestampMs, final long expected) throws Exception {
        assertEquals(expected, GameTimestampConverter.truncateHour(timestampMs));
    }
}